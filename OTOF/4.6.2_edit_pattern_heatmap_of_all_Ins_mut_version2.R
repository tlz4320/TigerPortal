...
right_anno <- rowAnnotation(DeleteNT = anno_barplot(insert_mat, 
...
pdf("~/Nutstore Files/Tobin/Previous/Del1_edit_distance_heatmap_total_recolor_v4.pdf", width = 9, height = 5)
ht <- Heatmap(plot_mat, 
              name = "EditDis",
