...
openxlsx::write.xlsx(ins_result_mean, file="~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_ins_frame_restore_total.xlsx", colNames=T, rowNames=F)
...
openxlsx::write.xlsx(na.omit(col_stat_data),
                     file= "~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_ins1_pct_in_indel.xlsx",
                     rowNames=F)
...
openxlsx::write.xlsx(tmp,
                     file= "~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_ins1_in_reframe.xlsx",
                     rowNames=F)
...
pdf("~/Nutstore Files/Tobin/Merged1NT/OTOF_sg1_no_ngg_7L_ins_top3.pdf", 
    width = 8, height = 1.3)
draw(ht)
...
openxlsx::write.xlsx(del_result_mean, file="~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_del_frame_restore_total.xlsx", colNames=T, rowNames=F)
...
openxlsx::write.xlsx(na.omit(col_stat)[,c(1,3,2)],
                     file= "~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_del2_pct_in_indel.xlsx", rowNames=F)
tmp <- del_result_mean[,c("Pct", "se")]
openxlsx::write.xlsx(tmp,
                     file= "~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_del2_pct_in_reframe.xlsx", rowNames=F)
...
pdf("~/Nutstore Files/Tobin/Merged1NT/OTOF_sg1_no_ngg_7L_del_top3.pdf", 
    width = 8, height = 1.3)
draw(ht)
decorate_annotation("pct",slice = 1, {
  od = 1 : 40
...
openxlsx::write.xlsx(stat_data, file="~/Nutstore Files/Tobin/Merged1NT/OTOF_7L_frame_restore_stat.xlsx")
