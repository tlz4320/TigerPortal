...
hek293_data <- openxlsx::read.xlsx("~/Nutstore Files/Tobin/Merged1NT/merged_del1_left_right_nt_pie_data.xlsx")

fake_plot_mat <- matrix(runif(12*4), nrow = 4, ncol = 12)
colnames(fake_plot_mat) <- c("A_tissue","A_cell","A_cell2", 
                             "T_tissue","T_cell", "T_cell2",
                             "C_tissue","C_cell", "C_cell2",
                             "G_tissue", "G_cell", "G_cell2")
...
ht <- Heatmap(fake_plot_mat,
              name = "Name",
              column_split = c(rep(c("", " ", "  ", "   "), c(3,3,3,3))),
              column_title=NULL,
              row_title = NULL,
              row_split = NULL,
              show_column_names = F, 
...
pdf("~/Nutstore Files/Tobin/Previous/tissue_cell_293T_del1_left_right_nt.pdf", 
    width = 16, height = 6)
...
tissue_data <- openxlsx::read.xlsx("~/Nutstore Files/Tobin/Previous/tissue_del1_left_right_nt_pie_data.xlsx")
cell_data <- openxlsx::read.xlsx("~/Nutstore Files/Tobin/Previous/cell_del1_left_right_nt_pie_data.xlsx")
hek293_data <- openxlsx::read.xlsx("~/Nutstore Files/Tobin/Merged1NT/merged_del1_left_right_nt_pie_data_add_forecast.xlsx")
...
pdf("~/Nutstore Files/Tobin/Previous/tissue_cell_293T_del1_left_right_nt_add_pred.pdf", 
    width = 16, height = 6)
draw(ht, annotation_legend_list = lgd_list)
library(gridtext)
for(i in 1 : 4){
