...
tmp <- total_plot_data2[total_plot_data2$dis == 3 & total_plot_data2$diff < 3,]
...
wilcox.test(total_plot_data2$diff[total_plot_data2$sameLeft & total_plot_data2$type == "Ref"], 
    total_plot_data2$diff[total_plot_data2$sameLeft & total_plot_data2$type != "Ref"], paired = T)
wilcox.test(total_plot_data2$diff[!total_plot_data2$sameLeft & total_plot_data2$type == "Ref"], 
    total_plot_data2$diff[!total_plot_data2$sameLeft & total_plot_data2$type != "Ref"], paired = T)
