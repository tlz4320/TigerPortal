...
pair_nt_diff <- read.table("~/data/project/ear_project/gene_therapy_ll/seqs_table_Del1_paired_output.txt", sep = "\t")
...
pdf("~/data/project/ear_project/gene_therapy_ll/NT_stat/Pos1_last_append_del1.pdf", width = 12, height = 6)
...
pdf("~/data/project/ear_project/gene_therapy_ll/NT_stat/Pos-1_first_append_del1.pdf", width = 12, height = 6)
...
pdf("~/data/project/ear_project/gene_therapy_ll/NT_stat/Pos1_first_append_del1.pdf", width = 12, height = 6)
...
pdf("~/data/project/ear_project/gene_therapy_ll/NT_stat/Pos-1_last_append_del1.pdf", width = 12, height = 6)
